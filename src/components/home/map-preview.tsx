...
const heroNodes: HeroNode[] = [
  {
    ...
    panel: {
      eyebrow: "HABILIDADE",
      summary: "Interfaces que comunicam com clareza e elevam a experiência",
      overview:
        "Crio interfaces digitais intuitivas, visualmente sofisticadas e alinhadas aos objetivos do produto. Cada detalhe é pensado para orientar, engajar e tornar a experiência mais fluida.",
  ...
  },
  {
    ...
    panel: {
      eyebrow: "HABILIDADE",
      summary: "Pesquisa, dados e leitura de comportamento para decisões melhores.",
      overview:
        "Estruturo jornadas, valido hipóteses e aprofundo investigações para descobrir o que realmente faz sentido para o usuário e para o negócio.",
  ...
  },
  {
    ...
    panel: {
      eyebrow: "HABILIDADE",
      summary: "Estrutura para escalar produtos com consistência visual e funcional",
      overview:
        "Crio design systems que organizam componentes, aceleram entregas e mantêm consistência entre diferentes fluxos, telas e equipes.",
  ...
  },
  {
    ...
    panel: {
      eyebrow: "HABILIDADE",
      summary: "Visão de produto para transformar ideias em resultados concretos",
      overview:
        "Cada projeto é conduzido com visão estratégica, conectando design, negócio e tecnologia para gerar valor real em cada decisão.",
  ...
  },
  {
    ...
    panel: {
      eyebrow: "HABILIDADE",
      summary: "Ideias ganhando forma antes da construção final",
      overview:
        "Transformo conceitos em protótipos interativos para validar fluxos, testar hipóteses e comunicar soluções com mais clareza antes do desenvolvimento.",
  ...
  },
  {
    ...
    panel: {
      eyebrow: "HABILIDADE",
      summary: "IA aplicada para acelerar fluxos de design-to-code",
      overview:
        "Uso inteligência artificial para acelerar o fluxo de design-to-code com apoio do MCP do Figma, gerando interfaces, componentes e iterações com mais velocidade e consistência.",
      ...
      <div className="relative mx-auto hidden h-[calc(100vh-80px)] min-h-[880px] w-full max-w-[1920px] overflow-hidden 2xl:block">
        <div className="absolute left-[240px] top-12 z-20 flex w-[401px] flex-col gap-6">
          ...
          <p className="text-[16px] leading-normal text-[#b9b9b9]">
            ...
            transformo ideias em produtos digitais com clareza, consistência e impacto.
          </p>
        ...
        <div className="absolute left-[240px] top-[520px] z-20 w-[272px] rounded-[12px] border border-[#224222] bg-[rgba(0,18,0,0.33)] p-6 backdrop-blur-[2px]">
          <div className="space-y-2">
            ...
            <div className="text-[16px] leading-normal text-[#b9b9b9]">
              <p>Criar produtos digitais que</p>
          ...
          <div className="relative z-10 mt-12 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div className="max-w-[14rem] rounded-[18px] border border-[#224222] bg-[rgba(0,18,0,0.48)] px-4 py-3 backdrop-blur-[5px]">
              ...
              <p className="mt-2 text-[12px] leading-5 text-white/66">
                Criar produtos digitais com clareza, impacto e uma atmosfera premium.
              </p>
            </div>
